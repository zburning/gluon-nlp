...
from pretraining_utils import get_pretrain_data_npz, get_dummy_dataloader
...
def train(data_train, data_eval, model):
    """Training function."""
    # backend specific implementation
    param_dict = model._electra.collect_params()
    if backend == 'horovod':
    ...
    running_mlm_loss, running_disc_loss = 0, 0
    running_num_tks = 0
    batch_num = 0
...
if __name__ == '__main__':
    ...
    model, vocab = get_ELECTRA_for_pretrain(ctxs, args.dataset_name)
